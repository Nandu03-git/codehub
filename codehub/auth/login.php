...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if ($row = $res->fetch_assoc()) {
    if (password_verify($pw, $row['password'])) {
      ...
      header("Location: /codehub/pages/home.php");
      exit;
    }
  }
  set_flash("Invalid credentials", "danger");
}
?>
...
<body>
  <div class="form-container">
    ...
    <form method="post" class="form">
      ...
      <div class="forgot">
  <a href="/codehub/auth/forgot_password.php">Forgot Password?</a>
</div>
    ...
    <p class="signup">
      ...
      <a href="/codehub/auth/register.php">Register</a>
    </p>
  </div>
</body>
</html>
